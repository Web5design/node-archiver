...
Archiver.prototype._pipeModuleOutput = function() {
  if (this.archiver.filter) {
    this.archiver.module.pipe(this.archiver.filter).pipe(this);
  } else {
...
Archiver.prototype.registerModule = function(module, options) {
  this.archiver.module = new module(options);
};

Archiver.prototype.registerOutputFilter = function(module, options) {
  this.archiver.filter = new module(options);
};